...
(Transaktionen, Budgets, Sparpläne, wiederkehrende Buchungen und Analytics).

Diese Dateien sind die Single Source of Truth: sie sind direkt auf GitHub lesbar
und werden zusätzlich als statische Doku-Site über GitHub Pages ausgeliefert.
...
- [API Reference](./api-reference.md) — Route Handlers und Verträge
